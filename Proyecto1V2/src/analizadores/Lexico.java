    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 70: break;
          case 5: 
            { return new Symbol(sym.LIT_NUMERO, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 71: break;
          case 6: 
          ...
          case 73: break;
          case 8: 
            { return new Symbol(sym.COMA, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 74: break;
          case 9: 
          ...
          case 82: break;
          case 17: 
            { return new Symbol(sym.LIT_CADENA, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 83: break;
          case 18: 
            { return new Symbol(sym.OR, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 84: break;
          case 19: 
            { return new Symbol(sym.SI, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 85: break;
          case 20: 
            { return new Symbol(sym.ASIGNACION, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 86: break;
          case 21: 
            { return new Symbol(sym.VARIABLE, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 87: break;
          case 22: 
            { return new Symbol(sym.LIT_CARACTER, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 88: break;
          case 23: 
            { return new Symbol(sym.AND, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 89: break;
          case 24: 
            { return new Symbol(sym.FIN, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 90: break;
          case 25: 
            { return new Symbol(sym.NOT, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 91: break;
          case 26: 
            { return new Symbol(sym.MODULO, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 92: break;
          case 27: 
            { return new Symbol(sym.O_SI, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 93: break;
          case 28: 
            { return new Symbol(sym.COMO, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 94: break;
          case 29: 
            { return new Symbol(sym.PARA, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 95: break;
          case 30: 
            { return new Symbol(sym.LIT_BOOLEAN, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 96: break;
          case 31: 
            { return new Symbol(sym.SEGUN, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 97: break;
          case 32: 
            { return new Symbol(sym.MENOR, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 98: break;
          case 33: 
            { return new Symbol(sym.MAYOR, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 99: break;
          case 34: 
            { return new Symbol(sym.HASTA, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 100: break;
          case 35: 
            { return new Symbol(sym.HACER, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 101: break;
          case 36: 
            { return new Symbol(sym.FIN_SI, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 102: break;
          case 37: 
            { return new Symbol(sym.INICIO,yyline,yycolumn + 1, yytext());
            } 
            // fall through
          case 103: break;
          case 38: 
          ...
          case 104: break;
          case 39: 
            { return new Symbol(sym.CADENA, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 105: break;
          case 40: 
            { return new Symbol(sym.METODO, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 106: break;
          case 41: 
            { return new Symbol(sym.REPETIR, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 107: break;
          case 42: 
            { return new Symbol(sym.FUNCION, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 108: break;
          case 43: 
            { return new Symbol(sym.BOOLEAN, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 109: break;
          case 44: 
            { return new Symbol(sym.ES_IGUAL, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 110: break;
          case 45: 
            { return new Symbol(sym.ENTONCES, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 111: break;
          case 46: 
            { return new Symbol(sym.EJECUTAR, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 112: break;
          case 47: 
            { return new Symbol(sym.RETORNAR, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 113: break;
          case 48: 
            { return new Symbol(sym.FIN_PARA, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 114: break;
          case 49: 
            { return new Symbol(sym.INGRESAR, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 115: break;
          case 50: 
            { return new Symbol(sym.IMPRIMIR, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 116: break;
          case 51: 
            { return new Symbol(sym.CARACTER, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 117: break;
          case 52: 
            { return new Symbol(sym.MIENTRAS, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 118: break;
          case 53: 
            { return new Symbol(sym.POTENCIA, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 119: break;
          case 54: 
            { return new Symbol(sym.FIN_SEGUN, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 120: break;
          case 55: 
            { return new Symbol(sym.CON_VALOR, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 121: break;
          case 56: 
            { return new Symbol(sym.HASTA_QUE, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 122: break;
          case 57: 
            { return new Symbol(sym.FIN_METODO, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 123: break;
          case 58: 
            { return new Symbol(sym.FIN_FUNCION, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 124: break;
          case 59: 
            { return new Symbol(sym.IMPRIMIR_NL, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 125: break;
          case 60: 
            { return new Symbol(sym.ES_DIFERENTE, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 126: break;
          case 61: 
            { return new Symbol(sym.FIN_MIENTRAS, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 127: break;
          case 62: 
            { return new Symbol(sym.MENOR_O_IGUAL, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 128: break;
          case 63: 
            { return new Symbol(sym.MAYOR_O_IGUAL, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 129: break;
          case 64: 
            { return new Symbol(sym.CON_PARAMETROS, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 130: break;
          case 65: 
            { return new Symbol(sym.DE_LO_CONTRARIO, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 131: break;
          case 66: 
            { return new Symbol(sym.CON_INCREMENTAL, yyline, yycolumn + 1, yytext());
            } 
            // fall through
          case 132: break;
          default:
